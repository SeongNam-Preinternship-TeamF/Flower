...
const Result = () => {
  return (
    <div className="w-full">
      <p
        className="mt-4 flex w-full justify-center text-4xl font-bold"
      ...
      <img
        className="w-200 mx-auto mt-4 flex justify-center"
        style={{ borderRadius: "4rem" }}
        alt="flower"
        src="url"
      />
      <div className="mt-4 flex justify-center text-2xl font-bold">꽃 이름</div>
      <div className="mx-16 mt-4 h-24 w-11/12 justify-center rounded-2xl text-center font-bold shadow-lg">
        꽃말
        <div className="mt-1 p-2 font-normal">
